...
function Birddog() {
    return (
        <div className='flex lg:flex-row flex-col justify-center items-center birddogbg px-4 py-5 lg:py-0 z-50 overflow-clip'>

            <div className="left lg:w-1/2 flex flex-col lg:justify-end justify-center items-center lg:items-end">
                {/* <img src={birddog} alt="birddog" className='w-9/12 lg:w-11/12 lg:ml-20 m-4 lg:mb-0' /> */}
                <Birddoganimation />
            </div>
