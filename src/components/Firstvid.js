        ...
        <div className='flex flex-col justify-center items-center px-4s my-20'>
            ...
            <div className="rows">
                <div className="row1 flex flex-row justify-center items-center ">
                    ...
                    <video src={mbcvideo1} alt="mbcvideo1" muted autoPlay loop className='w-1/3 lg:p-5 p-2 lg:rounded-[50px] rounded-xl' />
                ...
                <div className="row2 flex flex-row justify-center items-center ">
                    ...
                    <video src={gmevideo1} alt="gmevideo1" muted autoPlay loop className='w-1/4 lg:p-5 p-2 lg:rounded-[50px] rounded-xl' />
                    <video src={gmevideo2} alt="gmevideo2" muted autoPlay loop className='w-1/4 lg:p-5 p-2 lg:rounded-[50px] rounded-xl' />
                    <video src={gmevideo3} alt="gmevideo3" muted autoPlay loop className='w-1/4 lg:p-5 p-2 lg:rounded-[50px] rounded-xl' />
                </div>
                ...
                <div className="row2 flex flex-row justify-center items-center ">
                    ...
                    <video src={hodivideo} alt="hodivideo" muted autoPlay loop className='w-1/4 lg:p-5 p-2 lg:rounded-[50px] rounded-xl' />
                    <video src={hodivideo2} alt="hodivideo2" muted autoPlay loop className='w-1/4 lg:p-5 p-2 lg:rounded-[50px] rounded-xl' />
